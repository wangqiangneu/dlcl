...
_MODEL_NAME_ = "simple_dlcl_transformer"


@register_model(_MODEL_NAME_)
class SimpleDlclTransformerModel(FairseqModel):
    ...
    def add_args(parser):
        ...
        parser.add_argument('--encoder-history-type', default='learnable_dense')
        parser.add_argument('--decoder-history-type', default='learnable_dense')
    ...
    def build_model(cls, args, task):
        ...
        return SimpleDlclTransformerModel(encoder, decoder)
